...
public class SearchFilterFragment extends Fragment implements OnClickListener {
	...
	private static final String OTHER_LANGUAGE = "other_language";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_search_filter, container,
				false);
		timeList = (ListView) view
				.findViewById(R.id.set_time_list_search_filter_page);
		plotGrid = (GridView) view
				.findViewById(R.id.set_plot_grid_search_filter_page);
		languageGrid = (GridView) view
				.findViewById(R.id.set_language_grid_search_filter_page);
		saveButton = (ImageView) view
				.findViewById(R.id.button_save_filter_search_filter_page);
		minusActressButton = (ImageView) view
				.findViewById(R.id.minus_actress_button_search_filter_page);
		addActressButton = (ImageView) view
				.findViewById(R.id.add_actress_button_search_filter_page);
		minusActorButton = (ImageView) view
				.findViewById(R.id.minus_actor_button_search_filter_page);
		addActorButton = (ImageView) view
				.findViewById(R.id.add_actor_button_search_filter_page);
		actressNumber = (TextView) view
				.findViewById(R.id.actress_number_search_filter_page);
		actorNumber = (TextView) view
				.findViewById(R.id.actor_number_search_filter_page);
		...
		languageGrid.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == 5) {
					saveSearchSetting();
					goToNextPage(new OtherLanguageFragment());
				}
			}
		...
		getActivity().getActionBar().setTitle("筛选条件");
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.minus_actress_button_search_filter_page:
			minus(actressNumber);
			break;
		case R.id.add_actress_button_search_filter_page:
			add(actressNumber);
			break;
		case R.id.minus_actor_button_search_filter_page:
			minus(actorNumber);
			break;
		case R.id.add_actor_button_search_filter_page:
			add(actorNumber);
			break;
		case R.id.button_save_filter_search_filter_page:
			saveSearchSetting();
	...
	private void saveSearchSetting() {
		...
		SharedPreferences sp = getActivity().getSharedPreferences(
				SEARCH_FILTER, Context.MODE_PRIVATE);
