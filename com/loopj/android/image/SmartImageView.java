...
public class SmartImageView extends ImageView {
    ...
    public void setImageUrl(String url, int width, int height) {
        setImage(new WebImage(url, width, height));
    }

    public void setImageUrl(String url, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new WebImage(url), completeListener);
    }
    public void setImageUrl(String url, int width, int height, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new WebImage(url, width, height), completeListener);
    }
    
    public void setImageUrl(String url, final Integer fallbackResource) {
        setImage(new WebImage(url), fallbackResource);
    }
    public void setImageUrl(String url, int width, int height, final Integer fallbackResource) {
        setImage(new WebImage(url, width, height), fallbackResource);
    }
    ...
    public void setImageUrl(String url, int width, int height, final Integer fallbackResource, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new WebImage(url, width, height), fallbackResource, completeListener);
    }

    public void setImageUrl(String url, final Integer fallbackResource, final Integer loadingResource) {
        setImage(new WebImage(url), fallbackResource, loadingResource);
    }
    public void setImageUrl(String url, int width, int height, final Integer fallbackResource, final Integer loadingResource) {
        setImage(new WebImage(url, width, height), fallbackResource, loadingResource);
    }
    ...
    public void setImageUrl(String url, int width, int height, final Integer fallbackResource, final Integer loadingResource, SmartImageTask.OnCompleteListener completeListener) {
        setImage(new WebImage(url, width, height), fallbackResource, loadingResource, completeListener);
    }
    ...
    public SmartImageView setRound(boolean isRound) {
    ...
    public void setImage(final SmartImage image, final Integer fallbackResource, final Integer loadingResource, final SmartImageTask.OnCompleteListener completeListener) {
        ...
        currentTask.setOnCompleteHandler(new SmartImageTask.OnCompleteHandler() {
            ...
            public void onComplete(Bitmap bitmap) {
                if(bitmap != null) {
                	if (isRound) {                		                		
                		setImageBitmap(BitmapUtil.getCroppedBitmap(bitmap, SmartImageView.this.getWidth()));
                	} else {
                    ...
                    if(fallbackResource != null) {
                    	...
                    	setImageResource(R.drawable.picloadingerr);
                    }
                }
